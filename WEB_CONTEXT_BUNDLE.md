...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-257-erd-s-problem-257-b71cc0bd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-257"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-257-erd-s-problem-257-b71cc0bd-v1",
      "problem_contract_sha256": "ad880ef662b56946105e124c84943cb7fd3c28ac167a3c37147515c7da3752dc",
      "problem_id": "problem:um-ep-257-erd-s-problem-257-b71cc0bd",
      "route_id": "route:um-ep-257-erd-s-problem-257-b71cc0bd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-257-erd-s-problem-257-b71cc0bd-source-fidelity-01",
      "graph_id": "graph:um-ep-257-erd-s-problem-257-b71cc0bd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-257-erd-s-problem-257-b71cc0bd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-257-erd-s-problem-257-b71cc0bd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A\\subseteq \\mathbb{N}$ be an infinite set. Is $ \\sum_{n\\in A}\\frac{1}{2^n-1} $ irrational?"
          },
          "statement_sha256": "fabffb8e30f580e0c9219882265599e5170edb870d1530f0e9b15848c1513740"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-257-erd-s-problem-257-b71cc0bd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-257-erd-s-problem-257-b71cc0bd-root",
      "route_id": "route:um-ep-257-erd-s-problem-257-b71cc0bd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-257-6e577ca5ca5f",
        "url": "https://www.unsolvedmath.com/problems/EP-257"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
